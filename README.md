This GitHub Repo holds a model for SE4CSAI project for group 'Pancakes'. The project goal is to build an AI system with a NLP model for summarization and Machine Translation.
